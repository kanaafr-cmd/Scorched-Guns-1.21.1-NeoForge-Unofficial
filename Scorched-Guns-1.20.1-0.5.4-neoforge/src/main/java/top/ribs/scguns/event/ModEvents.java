...
public class ModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == ModVillagers.GUNSMITH.get()) {
            ...
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 8)),
                    new ItemStack(ModItems.GUN_GRIP.get(), 1),
                    10, 2, 0.02f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 9)),
                    new ItemStack(ModItems.GUN_BARREL.get(), 1),
                    10, 2, 0.02f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.SMALL_COPPER_CASING.get(), 6)),
                    new ItemStack(Items.EMERALD, 1),
                    10, 2, 0.02f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.IRON_INGOT, 4)),
                    new ItemStack(Items.EMERALD, 1),
                    12, 5, 0.02f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.BUCKSHOT.get(), 4)),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, 0.02f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 15)),
                    new ItemStack(ModItems.LONGARM.get(), 1),
                    3, 10, 0.05f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 2)),
                    new ItemStack(ModItems.SMALL_IRON_CASING.get(), 8),
                    10, 10, 0.05f));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.ANTHRALITE_INGOT.get(), 3)),
                    new ItemStack(Items.EMERALD, 1),
                    12, 10, 0.05f));

            // Level 2 Trades
            trades.get(2).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 25)),
            ...
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    6, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.GUN_PARTS.get(), 1)),
                    new ItemStack(Items.EMERALD, 4),
                    10, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.GUNPOWDER, 8)),
                    new ItemStack(Items.EMERALD, 1),
                    16, 15, 0.05f));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 8)),
            ...
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    4, 20, 0.05f));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 16)),
                    new ItemStack(ModItems.LONG_SCOPE.get(), 1),
                    4, 20, 0.05f));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.MEDIUM_BRASS_CASING.get(), 6)),
                    new ItemStack(Items.EMERALD, 1),
                    10, 20, 0.05f));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.BLAZE_POWDER, 4)),
                    new ItemStack(Items.EMERALD, 1),
                    12, 20, 0.05f));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 1)),
                    new ItemStack(ModItems.BLANK_MOLD.get(), 1),
                    5, 20, 0.05f));

            // Level 5 Trades
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 32)),
                    new ItemStack(ModItems.SAKETINI.get(), 1),
                    1, 25, 0.05f));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(Items.EMERALD, 35)),
            ...
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    1, 30, 0.05f));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.NITRO_POWDER.get(), 1)),
                    new ItemStack(Items.EMERALD, 28),
                    8, 25, 0.05f));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    cost(new ItemStack(ModItems.ANCIENT_BRASS.get(), 32)),
    ...
    public static void addCustomWanderingTrades(WandererTradesEvent event) {
        ...
        trades.add((pTrader, pRandom) -> new MerchantOffer(
                cost(new ItemStack(Items.EMERALD, 24)),
        ...
        trades.add((pTrader, pRandom) -> new MerchantOffer(
                ...
                1, 12, 0.15f));
        trades.add((pTrader, pRandom) -> new MerchantOffer(
                cost(new ItemStack(Items.EMERALD, 29)),
                new ItemStack(ModItems.WRECKER_FLARE.get(), 1),
                1, 12, 0.15f));
        trades.add((pTrader, pRandom) -> new MerchantOffer(
                cost(new ItemStack(Items.EMERALD, 29)),
        ...
        rareTrades.add((pTrader, pRandom) -> new MerchantOffer(
                cost(new ItemStack(Items.EMERALD, 23)),
