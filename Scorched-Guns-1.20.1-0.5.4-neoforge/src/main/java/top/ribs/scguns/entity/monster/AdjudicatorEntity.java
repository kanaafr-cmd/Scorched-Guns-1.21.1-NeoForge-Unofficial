        ...
        if (hasGun) {
            ...
            this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2D, false) {
                protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
                    if (pDistToEnemySqr <= this.mob.getBbWidth() * 2.0F * this.mob.getBbWidth() * 2.0F + pEnemy.getBbWidth() && this.getTicksUntilNextAttack() <= 0 && !AdjudicatorEntity.this.isAttacking()) {
