...
public class NeedleProjectileEntity extends ProjectileEntity {
    private static final float REUSE_CHANCE = 0.25F;
    private boolean canBeReused = false;

    public NeedleProjectileEntity(EntityType<? extends Entity> entityType, Level worldIn) {
        super(entityType, worldIn);
    }

    public NeedleProjectileEntity(EntityType<? extends Entity> entityType, Level worldIn, LivingEntity shooter, ItemStack weapon, GunItem item, Gun modifiedGun) {
