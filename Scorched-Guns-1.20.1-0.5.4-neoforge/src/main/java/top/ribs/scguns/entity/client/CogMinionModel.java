...
public class CogMinionModel<T extends Entity> extends HierarchicalModel<T> implements ArmedModel {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int packedColor) {
        ...
        tread.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        head.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        cog.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        hand.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
    }
