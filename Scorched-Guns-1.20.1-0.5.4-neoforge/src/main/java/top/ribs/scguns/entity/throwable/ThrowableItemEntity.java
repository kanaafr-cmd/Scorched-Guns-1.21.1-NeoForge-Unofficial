...
import top.ribs.scguns.compat.net.neoforged.neoforge.entity.IEntityAdditionalSpawnData;
...
public abstract class ThrowableItemEntity extends ThrowableProjectile implements IEntityAdditionalSpawnData
{
    ...
    public void writeSpawnData(FriendlyByteBuf buffer)
    {
        ...
        top.ribs.scguns.util.BufferUtil.writeItemStackToBufIgnoreTag(buffer, this.item);
    }
    ...
    public void readSpawnData(FriendlyByteBuf buffer)
    {
        ...
        this.item = top.ribs.scguns.util.BufferUtil.readItemStackFromBufIgnoreTag(buffer);
    }
