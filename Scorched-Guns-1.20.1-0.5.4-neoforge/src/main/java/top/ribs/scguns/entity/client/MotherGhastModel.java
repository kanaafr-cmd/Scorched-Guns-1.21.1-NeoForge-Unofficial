...
public class MotherGhastModel <T extends Entity> extends HierarchicalModel<T> {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int packedColor) {
        ...
        fin.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        gear_1.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        turret1.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        for(ModelPart tentacle : this.tentacles) {
            tentacle.render(poseStack, vertexConsumer, packedLight, packedOverlay, 0xFFFFFFFF);
        }
    }
}