 ...
 */
public class AuvtomagModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext transformType, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrixStack, MultiBufferSource buffer, int light, int overlay) {
        ...
        if ((Gun.getScope(stack) == null))
            RenderUtil.renderModel(SpecialModels.AUVTOMAG_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
        else
            RenderUtil.renderModel(SpecialModels.AUVTOMAG_NO_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
        ...
        if (entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.AUVTOMAG_RECEIVER.getModel(), stack, matrixStack, buffer, light, overlay);
            //Always pop
            matrixStack.popPose();
        }
    }
