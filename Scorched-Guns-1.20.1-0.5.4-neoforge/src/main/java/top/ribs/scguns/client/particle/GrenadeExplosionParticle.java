...
@OnlyIn(Dist.CLIENT)
public class GrenadeExplosionParticle extends TextureSheetParticle {
    ...
    protected GrenadeExplosionParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pSizeMultiplier, SpriteSet pSprites) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new GrenadeExplosionParticle(pLevel, pX, pY, pZ, pXSpeed, this.sprites);
        }
    }
}