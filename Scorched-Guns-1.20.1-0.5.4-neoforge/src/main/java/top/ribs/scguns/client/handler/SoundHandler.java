...
public class SoundHandler
{
    ...
    {
        for (String fieldName : new String[] { "instanceToChannel", "f_120226_" })
        {
            try
            {
                this.playingSounds = SoundEngine.class.getDeclaredField(fieldName);
    ...
    {
        if(event.phase == TickEvent.Phase.START || Minecraft.getInstance().player == null || this.soundEngine == null || this.playingSounds == null)
        {
            return;
        }
