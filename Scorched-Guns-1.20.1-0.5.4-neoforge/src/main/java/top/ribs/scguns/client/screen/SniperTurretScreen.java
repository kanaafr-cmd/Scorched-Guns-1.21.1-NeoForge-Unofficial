...
@OnlyIn(Dist.CLIENT)
public class SniperTurretScreen extends AbstractContainerScreen<SniperTurretMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("scguns", "textures/gui/basic_turret.png");
    public SniperTurretScreen(SniperTurretMenu menu, Inventory inv, Component title) {
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        SniperTurretBlockEntity turret = menu.getBlockEntity();
