...
public class PolarGeneratorScreen extends AbstractContainerScreen<PolarGeneratorMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "textures/gui/polar_generator_gui.png");
    ...
    public PolarGeneratorScreen(PolarGeneratorMenu menu, Inventory inv, Component title) {
    ...
    private void renderFuelBar(GuiGraphics guiGraphics, int x, int y) {
        if (menu.isGenerating()) {
            ...
            guiGraphics.blit(TEXTURE, x + 80, y + 42 - fuel, 176, 14 - fuel, 14, fuel + 1); // Adjusted y-coordinate
        }
    }
    ...
    private void renderEnergyTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        tooltip.add(Component.translatable("tooltip.polar_generator.energy", this.menu.getEnergy()));
