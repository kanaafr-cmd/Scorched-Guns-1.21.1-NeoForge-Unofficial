package top.ribs.scguns.common.container.slot;
...
public class AttachmentSlot extends Slot {
    ...
    public boolean mayPlace(ItemStack stack)
    {
        ...
        if(!currentItem.isEmpty() && hasBindingCurse(currentItem))
            return false;
    ...
    public boolean mayPickup(Player player)
    {
        ...
        return (itemstack.isEmpty() || player.isCreative() || !hasBindingCurse(itemstack)) && super.mayPickup(player);
    }

    private static boolean hasBindingCurse(ItemStack itemstack) {
