    ...
    public static void onAddReloadListener(AddReloadListenerEvent event) {
        event.addListener(new SimplePreparableReloadListener<Void>() {
            ...
            protected Void prepare(ResourceManager resourceManager, ProfilerFiller profiler) {
                clearAll();
                loadVentConfig(resourceManager, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "geothermal_vent"));
                loadVentConfig(resourceManager, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "sulfur_vent"));

                loadVentCollectorConfig(resourceManager, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "vent_collector"));

                VENT_CONFIGS.get(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "geothermal_vent"));
                COLLECTOR_CONFIGS.get(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "vent_collector"));
