...
public class ModParticleTypes {
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<BulletHoleData>> BULLET_HOLE = REGISTER.register("bullet_hole", () -> new ParticleType<BulletHoleData>(false) {
        @Override
        public com.mojang.serialization.MapCodec<BulletHoleData> codec() {
            return BulletHoleData.CODEC;
        }

        @Override
        public net.minecraft.network.codec.StreamCodec<? super net.minecraft.network.RegistryFriendlyByteBuf, BulletHoleData> streamCodec() {
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<TrailData>> TRAIL = REGISTER.register("trail", () -> new ParticleType<TrailData>(false) {
        @Override
        public com.mojang.serialization.MapCodec<TrailData> codec() {
            return TrailData.CODEC;
        }

        @Override
        public net.minecraft.network.codec.StreamCodec<? super net.minecraft.network.RegistryFriendlyByteBuf, TrailData> streamCodec() {
    ...
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> FIRE_GRENADE_EXPLOSION = REGISTER.register("fire_grenade_explosion", () -> new SimpleParticleType(true));
