...
public class ModTags
{
    ...
    public static class Blocks
    {
        ...
        {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "fragile"));
        }
    }
    ...
    public static class Items
    {
        ...
        public static boolean isInTierTag(ItemStack stack, GunTier tier) {
            ...
            TagKey<Item> tierTag = ItemTags.create(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, tier.getTagName()));
