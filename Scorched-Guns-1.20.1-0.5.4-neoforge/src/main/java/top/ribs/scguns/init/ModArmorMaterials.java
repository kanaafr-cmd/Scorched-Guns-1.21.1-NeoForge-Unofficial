...
public final class ModArmorMaterials {
    public static final Holder<ArmorMaterial> SCRAP = material("scrap", 6, new int[]{5, 6, 6, 4}, 9,
            SoundEvents.ARMOR_EQUIP_LEATHER, 0.5f, 0.05f, () -> Ingredient.of(Items.COPPER_INGOT));
    public static final Holder<ArmorMaterial> REDCOAT = material("redcoat", 12, new int[]{2, 4, 3, 2}, 9,
    ...
    public static final Holder<ArmorMaterial> ANTHRALITE = material("anthralite", 32, new int[]{3, 5, 4, 3}, 12,
            SoundEvents.ARMOR_EQUIP_GOLD, 1.0f, 0.05f, () -> Ingredient.of(ModItems.ANTHRALITE_INGOT.get()));
    public static final Holder<ArmorMaterial> DIAMOND_STEEL = material("diamond_steel", 36, new int[]{3, 7, 5, 3}, 16,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0f, 0.05f, () -> Ingredient.of(ModItems.DIAMOND_STEEL_INGOT.get()));
    public static final Holder<ArmorMaterial> TREATED_BRASS = material("treated_brass", 30, new int[]{4, 5, 5, 4}, 10,
