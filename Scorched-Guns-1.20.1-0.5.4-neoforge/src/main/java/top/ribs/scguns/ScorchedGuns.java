...
public class ScorchedGuns {
    ...
    public ScorchedGuns(IEventBus modEventBus, ModContainer modContainer) {
        ...
        CONDITION_SERIALIZERS.register("soul_fired_mod_loaded", () -> SoulFiredModCondition.CODEC);
        ...
        MinecraftForge.EVENT_BUS.register(GunnerMobSpawner.class);
        MinecraftForge.EVENT_BUS.register(ModCommandsRegister.class);
