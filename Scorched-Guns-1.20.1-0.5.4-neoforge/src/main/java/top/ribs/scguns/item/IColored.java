...
public interface IColored
{
    ...
    {
        CompoundTag tagCompound = ItemStackNbtHelper.getOrCreateTag(stack);
    ...
    default void setColor(ItemStack stack, int color)
    {
        ...
        ItemStackNbtHelper.setTag(stack, tagCompound);
    }
    ...
    static ItemStack dye(ItemStack stack, List<DyeItem> dyes)
    {
        ...
        if(IColored.isDyeable(stack))
        {
            ...
            for(DyeItem dyeitem : dyes)
            {
                ...
                int red = dyeColor >> 16 & 255;
                int green = dyeColor >> 8 & 255;
                int blue = dyeColor & 255;
