 ...
 * Author: MrCrayfish
 */
public class HellfireBombItem extends AmmoItem
{
    protected int maxCookTime;

    public HellfireBombItem(Properties properties, int maxCookTime)
    {
        super(properties);
    ...
    {
        return new ThrowableHellfireBombEntity(world, entity, timeLeft);
    }
