        ...
        if (!insertedStack.isEmpty() && insertedStack.is(ItemTags.create(((AmmoBoxItem)pouchStack.getItem()).getAmmoTag()))) {
            ...
            for (int i = 0; i < listTag.size(); i++) {
                ...
                if (ItemStack.isSameItemSameComponents(existingStack, insertedStack)) {
                    ...
                    listTag.set(i, ItemStackNbtHelper.save(existingStack));
                    if (itemsToInsert <= 0) {
                        break;
                    }
                }
            ...
            while (itemsToInsert > 0) {
                ...
                listTag.add(ItemStackNbtHelper.save(newItemStack));
            ...
            if (listTag.isEmpty()) {
                ...
                if (listTag.isEmpty()) {
                    ...
                    if (compoundTag.isEmpty()) {
                        ItemStackNbtHelper.removeTag(stack);
                    } else {
                        ItemStackNbtHelper.setTag(stack, compoundTag);
                    }
                }
