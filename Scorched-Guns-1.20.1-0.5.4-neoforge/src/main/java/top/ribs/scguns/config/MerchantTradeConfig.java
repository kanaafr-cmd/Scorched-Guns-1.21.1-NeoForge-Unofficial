...
public class MerchantTradeConfig {
    ...
    public static class TradeData {
        ...
        public MerchantOffer toMerchantOffer() {
            ItemCost costA = new ItemCost(buyItem.getItem(), buyItem.getCount());
            if (buyItem2.isEmpty()) {
                return new MerchantOffer(costA, sellItem, maxUses, xpReward, priceMultiplier);
            } else {
                ItemCost costB = new ItemCost(buyItem2.getItem(), buyItem2.getCount());
                return new MerchantOffer(costA, Optional.of(costB), sellItem, maxUses, xpReward, priceMultiplier);
            }
        }
    }
