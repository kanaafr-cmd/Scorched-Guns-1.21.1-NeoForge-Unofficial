...
import top.ribs.scguns.compat.net.minecraft.world.item.enchantment.ProtectionEnchantment;
...
public abstract class ProjectileExplosion extends Explosion
{
    ...
    {
        super(world, exploder, source, context, x, y, z, size, causesFire, mode, ParticleTypes.EXPLOSION, ParticleTypes.EXPLOSION_EMITTER, SoundEvents.GENERIC_EXPLODE);
        this.world = world;
        this.x = x;
        this.y = y;
        this.z = z;
        ...
        this.damageSource = source == null ? world.damageSources().explosion(this) : source;
    }

    protected DamageSource getProjectileDamageSource() {
    ...
    public void explode()
    {
        ...
        top.ribs.scguns.compat.net.neoforged.neoforge.event.ForgeEventFactory.onExplosionDetonate(this.world, this, entities, radius);
        ...
        for(Entity entity : entities)
        {
            ...
            entity.hurt(this.damageSource, (float) ((int) ((damage * damage + damage) / 2.0D * 7.0D * (double) radius + 1.0D)));
