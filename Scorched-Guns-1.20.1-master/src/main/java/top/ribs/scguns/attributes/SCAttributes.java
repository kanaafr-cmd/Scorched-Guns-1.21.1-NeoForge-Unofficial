...
public class SCAttributes {
    public static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(BuiltInRegistries.ATTRIBUTE, ScorchedGuns.MODID);
    ...
    //public static final DeferredHolder<?, Attribute> FIRE_RATE_MULTIPLIER = ATTRIBUTES.register("fire_rate_multiplier",
    //        () -> new RangedAttribute("attribute.scguns.fire_rate_multiplier", 0.0F, -1000.0F, 99.9F)
    //                .setSyncable(true)
    //);

    public static final DeferredHolder<Attribute, Attribute> ADDITIONAL_BULLET_DAMAGE = ATTRIBUTES.register("additional_bullet_damage",
    ...
    public static final DeferredHolder<Attribute, Attribute> BULLET_DAMAGE_MULTIPLIER = ATTRIBUTES.register("bullet_damage_multiplier",
    ...
    //public static final DeferredHolder<?, Attribute> BULLET_RESISTANCE = ATTRIBUTES.register("bullet_resistance",
    //        () -> new RangedAttribute("attribute.scguns.bullet_resistance", 0.0, 0, 100.0)
    //                .setSyncable(true)
    //);
    public static final DeferredHolder<Attribute, Attribute> SPREAD_MULTIPLIER = ATTRIBUTES.register("spread_multiplier",
            () -> new RangedAttribute("attribute.scguns.spread_multiplier", 1.0, 0, 1000.0)
                    .setSyncable(true)
    );

    public static Holder<Attribute> holder(DeferredHolder<Attribute, Attribute> attribute) {
