    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false) {
            ...
            protected void checkAndPerformAttack(LivingEntity pEnemy) {
                double distance = this.mob.distanceToSqr(pEnemy);
                double reach = net.minecraft.util.Mth.square(this.mob.getBbWidth() * 2.0F) + pEnemy.getBbWidth();
                if (distance <= reach && this.getTicksUntilNextAttack() <= 0 && !TraumaUnitEntity.this.isAttacking()) {
