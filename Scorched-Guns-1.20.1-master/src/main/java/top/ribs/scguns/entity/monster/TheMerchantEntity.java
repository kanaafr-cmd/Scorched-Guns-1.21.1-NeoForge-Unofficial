...
public class TheMerchantEntity extends PathfinderMob implements Merchant {
    ...
    protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder) {
        ...
        builder.define(DESPAWN_TIMER, DEFAULT_DESPAWN_TIME);
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        MerchantOffers.CODEC.encodeStart(NbtOps.INSTANCE, this.offers)
                .result()
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (compound.contains("Offers", Tag.TAG_LIST)) {
            MerchantOffers.CODEC.parse(NbtOps.INSTANCE, compound.get("Offers"))
                    .result()
