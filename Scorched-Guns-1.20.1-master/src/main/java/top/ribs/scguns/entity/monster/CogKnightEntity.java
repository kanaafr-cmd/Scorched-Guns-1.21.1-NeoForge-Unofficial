    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false) {
            ...
            protected void checkAndPerformAttack(LivingEntity pEnemy) {
                ...
                double reach = Mth.square(this.mob.getBbWidth() * 2.0F) + pEnemy.getBbWidth();
                if (distance <= reach * 1.5 && this.getTicksUntilNextAttack() <= 0 && !CogKnightEntity.this.isAttacking()) {
