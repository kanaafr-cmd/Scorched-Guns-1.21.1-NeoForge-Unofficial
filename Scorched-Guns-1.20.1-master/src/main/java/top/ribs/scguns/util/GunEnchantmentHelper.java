...
public class GunEnchantmentHelper
{
    ...
    public static int getReloadInterval(ItemStack weapon) {
        ...
        int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.QUICK_HANDS, weapon);
    ...
    {
        int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.LIGHTWEIGHT, weapon);
        return level > 0 ? 1.2 : 1.0;
    }

    public static double getProjectileSpeedModifier(ItemStack weapon) {
        int acceleratorLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.ACCELERATOR, weapon);
        int heavyShotLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.HEAVY_SHOT, weapon);
    ...
    public static int getRate(ItemStack weapon, Gun modifiedGun) {
        ...
        int triggerFingerLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.TRIGGER_FINGER, weapon);
        int heavyShotLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.HEAVY_SHOT, weapon);
    ...
    public static float getHeavyShotDamage(ItemStack weapon, float damage) {
        int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.HEAVY_SHOT, weapon);
        if (level > 0) {
    ...
    public static ParticleOptions getParticle(ItemStack weapon) {
        if (EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.PUNCTURING, weapon) > 0) {
            return ParticleTypes.ENCHANTED_HIT;
        } else if (EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.HEAVY_SHOT, weapon) > 0) {
            return ParticleTypes.MYCELIUM;
        } else if (EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.ELEMENTAL_POP, weapon) > 0) {
    ...
    {
        int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.PUNCTURING, weapon);
        return level * 0.05F;
    }
    ...
    public static float getWaterProofDamage(ItemStack weapon, Player player, float damage) {
        int waterProofLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.WATER_PROOF, weapon);
    ...
    public static void applyElementalPopEffect(ItemStack weapon, LivingEntity target) {
        int enchantmentLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.ELEMENTAL_POP, weapon);
    ...
    public static int getQuickHands(ItemStack stack) {
        return EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.QUICK_HANDS, stack);
    }

    public static int getLightweight(ItemStack stack) {
        return EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.LIGHTWEIGHT, stack);
    }
}
