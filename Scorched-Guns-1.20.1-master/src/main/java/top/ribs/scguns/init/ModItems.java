...
public class ModItems {
    ...
    public static DeferredHolder<Item, GunItem> GALE;
    public static DeferredHolder<Item, GunItem> UMAX_PISTOL;
    public static DeferredHolder<Item, Item> VENTURI;
    public static DeferredHolder<Item, Item> SCRATCHES;
    ...
    public static final DeferredHolder<Item, AnimatedGunItem> INERTIAL = REGISTER.register("inertial",
            () -> new AnimatedDiamondSteelGunItem(
                    new Item.Properties().stacksTo(1).durability(1350),
                    "inertial",
                    ModSounds.MAG_OUT.get(),
    ...
    public static final DeferredHolder<Item, AnimatedGunItem> SEQUOIA = REGISTER.register("sequoia",
            () -> new AnimatedGunItem(
                    new Item.Properties().stacksTo(1).durability(1400),
                    "sequoia",
                    ModSounds.MAG_OUT.get(),
    ...
    public static final DeferredHolder<Item, AnimatedGunItem> BOMB_LANCE = REGISTER.register("bomb_lance",
            () -> new AnimatedGunItem(
                    new Item.Properties().stacksTo(1).durability(800),
                    "bomb_lance",
                    ModSounds.MAG_OUT.get(),
   ...
   public static final DeferredHolder<Item, PickaxeItem> ANTHRALITE_PICKAXE = REGISTER.register("anthralite_pickaxe", () -> new PickaxeItem(ModTiers.ANTHRALITE, new Item.Properties().attributes(PickaxeItem.createAttributes(ModTiers.ANTHRALITE, 1.0F, -2.8F))));
    ...
    public static final DeferredHolder<Item, AxeItem> ANTHRALITE_AXE = REGISTER.register("anthralite_axe", () -> new AxeItem(ModTiers.ANTHRALITE, new Item.Properties().attributes(AxeItem.createAttributes(ModTiers.ANTHRALITE, 5.0F, -3.0F))));
    public static final DeferredHolder<Item, ShovelItem> ANTHRALITE_SHOVEL = REGISTER.register("anthralite_shovel", () -> new ShovelItem(ModTiers.ANTHRALITE, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.ANTHRALITE, 1.5F, -3.0F))));
    public static final DeferredHolder<Item, HoeItem> ANTHRALITE_HOE = REGISTER.register("anthralite_hoe", () -> new HoeItem(ModTiers.ANTHRALITE, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.ANTHRALITE, -3.0F, -3.0F))));
    ...
    public static final DeferredHolder<Item, Item> TREATED_BRASS_HELMET = REGISTER.register("treated_brass_helmet", () -> new ArmorItem(ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final DeferredHolder<Item, Item> TREATED_BRASS_CHESTPLATE = REGISTER.register("treated_brass_chestplate", () -> new ArmorItem(ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final DeferredHolder<Item, Item> TREATED_BRASS_LEGGINGS = REGISTER.register("treated_brass_leggings", () -> new ArmorItem(ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final DeferredHolder<Item, Item> TREATED_BRASS_BOOTS = REGISTER.register("treated_brass_boots", () -> new ArmorItem(ModArmorMaterials.TREATED_BRASS, ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> PHOSPHOR_DUST = REGISTER.register("phosphor_dust", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> ADVANCED_ROUND = REGISTER.register("advanced_round",
    ...
    public static final DeferredHolder<Item, Item> KRAHG_ROUND = REGISTER.register("krahg_round",
            () -> new TooltipAmmo(new Item.Properties(), 4));
    public static final DeferredHolder<Item, Item> BEOWULF_ROUND = REGISTER.register("beowulf_round",
            () -> new TooltipAmmo(new Item.Properties(), 2));
    public static final DeferredHolder<Item, Item> GIBBS_ROUND = REGISTER.register("gibbs_round",
            () -> new TooltipAmmo(new Item.Properties(), 2));
    ...
    public static final DeferredHolder<Item, Item> SCULK_CELL = REGISTER.register("sculk_cell",
    ...
    public static final DeferredHolder<Item, Item> MICROJET = REGISTER.register("microjet", () -> new AmmoItem(new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> GRENADE = REGISTER.register("grenade", () -> new GrenadeItem(new Item.Properties().stacksTo(32), 10 * 3));
    ...
    // Stock Attachments
    public static final DeferredHolder<Item, Item> LIGHT_STOCK = REGISTER.register("light_stock", () -> new StockItem(Stock.create(GunModifiers.LIGHT_STOCK_MODIFIER), new Item.Properties().stacksTo(1).durability(1300), false));
    ...
    // Barrel Attachments
    public static final DeferredHolder<Item, Item> SILENCER = REGISTER.register("silencer", () -> new BarrelItem(Barrel.create(0.0F, GunModifiers.SILENCER_MODIFIER, GunModifiers.SILENCED, GunModifiers.REDUCED_DAMAGE), new Item.Properties().stacksTo(1).durability(550)));
    ...
    public static final DeferredHolder<Item, Item> REDCOAT_SPAWN_EGG = REGISTER.register("redcoat_spawn_egg", () -> new DeferredSpawnEggItem(ModEntities.REDCOAT, 0xa02727, 0x74913a, new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> BLUNDERER_SPAWN_EGG = REGISTER.register("blunderer_spawn_egg", () -> new DeferredSpawnEggItem(ModEntities.BLUNDERER, 0x32663c, 0x98a2a2, new Item.Properties()));
