...
public class ModDamageTypes
{
    ...
    public static final ResourceKey<DamageType> MELEE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "melee"));
        ...
        public static class BulletDamageSource extends DamageSource {
            ...
            public Component getLocalizedDeathMessage(LivingEntity pLivingEntity) {
                ...
                if (this.getEntity() == null && this.getDirectEntity() == null) {
                    ...
                    return isSilenced ? Component.translatable(s + ".silenced", pLivingEntity.getDisplayName()) : !stack.isEmpty() && stack.has(DataComponents.CUSTOM_NAME) ?
