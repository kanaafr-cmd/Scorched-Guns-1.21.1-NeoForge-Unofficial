 ...
 * Author: MrCrayfish
 */
public class ChokeBombItem extends AmmoItem
{
    protected int maxCookTime;

    public ChokeBombItem(Properties properties, int maxCookTime)
    {
        super(properties);
    ...
    {
        return new ThrowableChokeBombEntity(world, entity, timeLeft, radius);
    }
