...
public class EnemyLogItem extends TeamLogItem {
    ...
    @Override
    public void appendHoverText(ItemStack stack, @Nullable net.minecraft.world.item.Item.TooltipContext level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
