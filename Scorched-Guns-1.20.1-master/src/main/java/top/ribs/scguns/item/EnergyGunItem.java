...
public class EnergyGunItem extends GunItem implements IEnergyGun {
    ...
    public int getEnergyStored(ItemStack stack) {
        return top.ribs.scguns.compat.net.neoforged.neoforge.common.util.LazyOptional.ofNullable(stack.getCapability(net.neoforged.neoforge.capabilities.Capabilities.EnergyStorage.ITEM)).map(IEnergyStorage::getEnergyStored).orElse(0);
    }

    public int getMaxEnergyStored(ItemStack stack) {
        return top.ribs.scguns.compat.net.neoforged.neoforge.common.util.LazyOptional.ofNullable(stack.getCapability(net.neoforged.neoforge.capabilities.Capabilities.EnergyStorage.ITEM)).map(IEnergyStorage::getMaxEnergyStored).orElse(0);
    }

    @Override
    public void appendHoverText(ItemStack stack, net.minecraft.world.item.Item.TooltipContext worldIn, List<Component> tooltip, TooltipFlag flag) {
