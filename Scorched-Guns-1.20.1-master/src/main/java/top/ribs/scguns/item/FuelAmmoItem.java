...
public class FuelAmmoItem extends Item implements IAmmo {
    ...
    public FuelAmmoItem(Properties properties, int burnTime, Supplier<Item> containerItem, MobEffectInstance... potionEffects) {
        super(properties.craftRemainder(containerItem.get()));
    ...
    @Override
    public void appendHoverText(@NotNull ItemStack stack, net.minecraft.world.item.Item.TooltipContext world, List<Component> tooltip, TooltipFlag flag) {
