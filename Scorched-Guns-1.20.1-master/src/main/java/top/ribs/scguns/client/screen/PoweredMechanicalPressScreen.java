...
public class PoweredMechanicalPressScreen extends AbstractContainerScreen<PoweredMechanicalPressMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "textures/gui/powered_mechanical_press_gui.png");
    private static final int BAR_WIDTH = 7;
    private static final int BAR_HEIGHT = 42;
    private static final int BAR_X = 14; // Adjusted position
    private static final int BAR_Y = 21; // Adjusted position
    private static final int TEXTURE_BAR_X = 176;
    private static final int TEXTURE_BAR_Y = 32; // Adjusted position in the texture

    public PoweredMechanicalPressScreen(PoweredMechanicalPressMenu menu, Inventory inv, Component title) {
    ...
    private void renderEnergyTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        tooltip.add(Component.translatable("tooltip.powered_mechanical_press.energy", this.menu.getEnergy()));
