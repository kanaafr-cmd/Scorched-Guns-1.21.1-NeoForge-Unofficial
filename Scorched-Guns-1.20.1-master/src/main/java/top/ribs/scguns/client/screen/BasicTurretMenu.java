...
public class BasicTurretMenu extends AbstractContainerMenu {
    ...
    public BasicTurretMenu(int id, Inventory playerInventory, FriendlyByteBuf extraData) {
        this(id, playerInventory, playerInventory.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public BasicTurretMenu(int id, Inventory playerInventory, BlockEntity entity) {
        super(ModMenuTypes.BASIC_TURRET_MENU.get(), id);
