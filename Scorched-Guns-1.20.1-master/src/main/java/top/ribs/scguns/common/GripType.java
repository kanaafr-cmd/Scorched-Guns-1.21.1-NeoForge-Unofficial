...
public record GripType(ResourceLocation id, IHeldAnimation heldAnimation) {
    ...
    public static final GripType ONE_HANDED_2 = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "one_handed_2"), new OneHanded2Pose());
    /**
    ...
    public static final GripType TWO_HANDED_SHOTGUN = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "two_handed_shotgun"), new TwoHandedShotgunPose());
    public static final GripType TWO_HANDED_SMG = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "two_handed_smg"), new TwoHandedSmgPose());
   public static final GripType DUAL_WIELD = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "dual_wield"), new DualWieldPose());
    /**
     ...
     * unique way to hold the weapon
     */
    public static final GripType MINI_GUN_2 = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mini_gun_2"), new MiniGun2Pose());


    public static final GripType MINI_GUN_3 = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mini_gun_3"), new MiniGun3Pose());
    public static final GripType MINI_GUN_4 = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mini_gun_4"), new MiniGun4Pose());
    public static final GripType MINI_GUN_5 = new GripType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mini_gun_5"), new MiniGun5Pose());
