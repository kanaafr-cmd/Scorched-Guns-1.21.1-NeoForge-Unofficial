...
public record ReloadType(ResourceLocation id) {
     ...
     */
    public static final ReloadType MANUAL = new ReloadType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "manual"));

    /**
     * A reload system that works with magazines (stacks of items)
     */
    public static final ReloadType MAG_FED = new ReloadType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mag_fed"));

    /**
     * A reload system which takes 1 item to fill an entire gun
     */
    public static final ReloadType SINGLE_ITEM = new ReloadType(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "single_item"));
