...
public class ExoSuitPowerManager {
    ...
    public static boolean consumeEnergy(Player player, String upgradeType, int energyRequired) {
        ...
        return top.ribs.scguns.compat.net.neoforged.neoforge.common.util.LazyOptional.ofNullable(powerCore.getCapability(net.neoforged.neoforge.capabilities.Capabilities.EnergyStorage.ITEM))
                .map(energyStorage -> {
